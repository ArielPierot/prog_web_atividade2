 ...
 * @author Ariel Pierot
 */
@WebServlet(name = "ListarDisciplinas", urlPatterns = {"/ListarDisciplinas"})
public class ListarDisciplinas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) { 
            ...
            ResultSet resultSet = statement.executeQuery("SELECT disciplinas.id, disciplinas.codigo, disciplinas.nome, disciplinas.n_creditos, pre_req1.nome AS pre_requisito_1, pre_req2.nome AS pre_requisito_2 FROM disciplinas "
                    + "LEFT JOIN disciplinas AS pre_req1 ON pre_req1.id = disciplinas.pre_req_1 "
                    + "LEFT JOIN disciplinas AS pre_req2 ON pre_req2.id = disciplinas.pre_req_2 "
