 ...
 * @author Ariel Pierot
 */
@WebServlet(name = "BuscarDisciplina", urlPatterns = {"/BuscarDisciplina"})
public class BuscarDisciplina extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) { 
            ...
            ResultSet resultSet = statement.executeQuery("SELECT disciplinas.id, disciplinas.codigo, disciplinas.nome, disciplinas.n_creditos, disciplinas.pre_req_1, disciplinas.pre_req_2 FROM disciplinas "
                    + "WHERE disciplinas.id = " + id + " ORDER BY disciplinas.nome LIMIT 1 ;");
